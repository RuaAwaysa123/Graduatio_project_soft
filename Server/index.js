...
//  });
//const corsOptions = {
//  origin: 'http://localhost:61302',  // Replace with your Flutter web app's domain
//};
//app.use(cors(corsOptions));
////app.use((req, res, next) => {
////    res.header('Access-Control-Allow-Origin', 'http://localhost:61302');  // Replace with your Flutter web app's domain
...
const authRouter = require("./routes/app");
const societyRouter = require("./routes/society_apis");
const course_centerRouter = require("./routes/Cource_Center_routes");
