...
class _RootAppCourcesState extends State<RootAppCources>
  ...
  List _barItems = [
    ...
    },
    {
      ...
      "active_icon": "assets/navigator_icons/analysis_simple.svg",
      "page": piechart(), //MyHomePage
    },
    {
    ...
    },
    {
      ...
      "page": MyHomePageTest(title: 'Flutter Demo Home Page', key: UniqueKey()),// // SocietyProfileScreen   //CourceProfile// SocietyProfileScreen
    },
  ];
